...
connectionChat.on("MessageReceivedPM", function (userDisplayName, message, userPortraitUrl, senderUserName) {
    ...
    else { li.className = "d-flex mb-3 justify-content-start"; }

    const portraitDiv = document.createElement("div");
    if (isMe) { portraitDiv.className = "ms-2"; }
    ...
    imgPortrait.src = userPortraitUrl;

    const bubble = document.createElement("div");
    if (isMe) { bubble.className = "chat-bubble bubble-me"; }
