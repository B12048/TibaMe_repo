...
namespace BoardGameFontier.Repostiory.Migrations
{
    ...
    [Migration("20250721153608_AddPostAndUserProfileSeedData")]
    partial class AddPostAndUserProfileSeedData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BoardGameFontier.Repostiory.Entity.Reel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2025, 7, 21, 23, 36, 8, 250, DateTimeKind.Local).AddTicks(6061),
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2025, 7, 21, 23, 36, 8, 250, DateTimeKind.Local).AddTicks(6064),
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2025, 7, 21, 23, 36, 8, 250, DateTimeKind.Local).AddTicks(6065),
                        ...
                        {
                            Id = 5,
                            Created = new DateTime(2025, 7, 21, 23, 36, 8, 250, DateTimeKind.Local).AddTicks(6066),
            ...
            modelBuilder.Entity("BoardGameFontier.Repostiory.Entity.Social.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CommentCount = 8,
                            Content = "剛接觸這款遊戲，發現策略深度比想像中高！分享一些新手心得：\n\n1. 前期重視資源累積\n2. 觀察對手動向\n3. 適時保留卡片\n\n有同樣興趣的朋友歡迎一起討論！",
                            CreatedAt = new DateTime(2025, 7, 21, 21, 36, 8, 250, DateTimeKind.Local).AddTicks(6221),
                            GameDetailId = 1,
                            IsPinned = false,
                            IsPopular = false,
                            LikeCount = 12,
                            Title = "《璀璨寶石》新手心得分享",
                            Type = 0,
                            UpdatedAt = new DateTime(2025, 7, 21, 21, 36, 8, 250, DateTimeKind.Local).AddTicks(6226),
                            ViewCount = 156
                        },
                        new
                        {
                            ...
                            CommentCount = 15,
                            Content = "最近剛買了七大奇蹟，想請教一下各位前輩：\n\n建築的優先順序應該怎麼安排？是先發展經濟還是軍事？\n\n感謝解答！",
                            CreatedAt = new DateTime(2025, 7, 21, 19, 36, 8, 250, DateTimeKind.Local).AddTicks(6230),
                            IsPinned = false,
                            IsPopular = false,
                            LikeCount = 5,
                            Title = "請問《七大奇蹟》的建築順序？",
                            Type = 1,
                            UpdatedAt = new DateTime(2025, 7, 21, 19, 36, 8, 250, DateTimeKind.Local).AddTicks(6230),
                            ViewCount = 234
                        },
                        new
                        {
                            ...
                            CommentCount = 6,
                            Content = "搬家出清，《卡坦島》基本版，只玩過2-3次，狀況良好。\n\n原價：1200元\n售價：800元\n地點：台北捷運可面交",
                            CreatedAt = new DateTime(2025, 7, 21, 17, 36, 8, 250, DateTimeKind.Local).AddTicks(6240),
                            IsPinned = false,
                            IsPopular = false,
                            LikeCount = 3,
                            Price = 800m,
                            Title = "《卡坦島》基本版 - 近全新",
                            Type = 2,
                            UpdatedAt = new DateTime(2025, 7, 21, 17, 36, 8, 250, DateTimeKind.Local).AddTicks(6240),
                            ViewCount = 89
                        },
                        new
                        {
                            ...
                            AuthorId = "test-user-001",
                            CommentCount = 12,
                            Content = "花了一個週末時間，終於完成《翼展》的木製收納盒！\n\n使用了櫸木材質，完美收納所有配件。分享一下製作過程和成果照片～\n\n有興趣的朋友可以參考設計圖。",
                            CreatedAt = new DateTime(2025, 7, 21, 15, 36, 8, 250, DateTimeKind.Local).AddTicks(6243),
                            IsPinned = false,
                            IsPopular = false,
                            LikeCount = 28,
                            Title = "自製《翼展》收納盒完成！",
                            Type = 3,
                            UpdatedAt = new DateTime(2025, 7, 21, 15, 36, 8, 250, DateTimeKind.Local).AddTicks(6244),
                            ViewCount = 445
                        });
                });
            ...
            modelBuilder.Entity("BoardGameFontier.Repostiory.Entity.UserProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AllowLikeNotifications = true,
                            AllowSearch = true,
                            AllowTradeNotifications = true,
                            Bio = "",
                            ConcurrencyStamp = "2ebaae30-34bf-4210-94c5-884b687607fe",
                            CreatedAt = new DateTime(2025, 4, 21, 23, 36, 8, 250, DateTimeKind.Local).AddTicks(6177),
                            DisplayName = "桌遊新手",
                            ...
                            UpdatedAt = new DateTime(2025, 7, 21, 23, 36, 8, 250, DateTimeKind.Local).AddTicks(6154),
                            UserName = "桌遊新手"
                        },
                        new
                        {
                            ...
                            AllowTradeNotifications = true,
                            Bio = "",
                            ConcurrencyStamp = "65a4cb20-4e56-4f6a-bb8e-ef5bfca44315",
                            CreatedAt = new DateTime(2025, 5, 21, 23, 36, 8, 250, DateTimeKind.Local).AddTicks(6190),
                            DisplayName = "策略玩家",
                            ...
                            ShowTradeHistory = false,
                            TwoFactorEnabled = false,
                            UpdatedAt = new DateTime(2025, 7, 21, 23, 36, 8, 250, DateTimeKind.Local).AddTicks(6188),
                            UserName = "策略玩家"
                        },
                        new
                        {
                            ...
                            AllowTradeNotifications = true,
                            Bio = "",
                            ConcurrencyStamp = "9116e1b1-6234-4401-bd71-262450761bd9",
                            CreatedAt = new DateTime(2025, 6, 21, 23, 36, 8, 250, DateTimeKind.Local).AddTicks(6195),
                            DisplayName = "遊戲收藏家",
                            ...
                            ShowTradeHistory = false,
                            TwoFactorEnabled = false,
                            UpdatedAt = new DateTime(2025, 7, 21, 23, 36, 8, 250, DateTimeKind.Local).AddTicks(6193),
                            UserName = "遊戲收藏家"
                        });
                });
